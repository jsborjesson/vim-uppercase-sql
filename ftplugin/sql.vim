...
iabbrev <expr> <buffer> bigserial <SID>UppercaseKeyword('bigserial')
iabbrev <expr> <buffer> smallserial <SID>UppercaseKeyword('smallserial')
iabbrev <expr> <buffer> money <SID>UppercaseKeyword('money')
iabbrev <expr> <buffer> point <SID>UppercaseKeyword('point')
iabbrev <expr> <buffer> line <SID>UppercaseKeyword('line')
iabbrev <expr> <buffer> lseg <SID>UppercaseKeyword('lseg')
iabbrev <expr> <buffer> box <SID>UppercaseKeyword('box')
iabbrev <expr> <buffer> path <SID>UppercaseKeyword('path')
iabbrev <expr> <buffer> polygon <SID>UppercaseKeyword('polygon')
iabbrev <expr> <buffer> circle <SID>UppercaseKeyword('circle')
